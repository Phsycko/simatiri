...
export const metadata: Metadata = {
    title: 'Paquete 4 - CHEPE Express Clase Turista | SIMATIRI',
    description: '5 Días / 4 Noches. Creel – Divisadero. Hospedaje Categoría Superior.',
}
    ...
    return (
        <div className="bg-[#f8f9fa] min-h-screen">
            ...
            <section
                ...
                style={{
                    backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.35) 40%, rgba(0,0,0,0.15) 70%, rgba(0,0,0,0.05) 100%), url('/images/packages/package-4.jpg')`,
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        ...
                        <div className="flex flex-col gap-3 min-w-[280px]">
                            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-5">
                                ...
                                <div className="font-serif text-3xl font-semibold mb-3">$10,100 MXN</div>
                                <Link
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                ...
                                <div className="font-serif text-4xl text-[#0a192f] mb-2">$11,400 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                <div className="text-lg font-medium text-[#7B4B2A]">$635 <span className="text-sm">USD</span></div>
                            </div>
                            <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                <div className="text-xs uppercase tracking-widest text-gray-400 font-semibold mb-6">Ocupación Triple</div>
                                <div className="font-serif text-4xl text-[#0a192f] mb-2">$10,200 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                <div className="text-lg font-medium text-[#7B4B2A]">$565 <span className="text-sm">USD</span></div>
                            </div>
                            <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                <div className="text-xs uppercase tracking-widest text-gray-400 font-semibold mb-6">Ocup. Cuádruple</div>
                                <div className="font-serif text-4xl text-[#0a192f] mb-2">$10,100 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                <div className="text-lg font-medium text-[#7B4B2A]">$560 <span className="text-sm">USD</span></div>
                            </div>
                        </div>
                    </section>
                ...
                <div className="hidden lg:block lg:col-span-4 transition-all">
                    <div className="sticky top-32 bg-white rounded-3xl border border-gray-100 shadow-xl shadow-black/5 p-8">
                        <div className="mb-8">
                            ...
                            <h3 className="font-serif text-2xl text-[#0a192f]">Paquete 4</h3>
                        </div>
                        ...
                        <div className="bg-[#f8f9fa] rounded-2xl p-6 mb-6">
                            ...
                            <div className="font-serif text-3xl text-[#0a192f]">$10,100 <span className="text-base text-gray-500 font-sans">MXN</span></div>
                        </div>
