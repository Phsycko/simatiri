...
export const metadata: Metadata = {
    ...
    description: '5 Días / 4 Noches. Creel – Divisadero. Hospedaje Categoría Intermedia.',
}
    ...
    return (
        <div className="bg-[#f8f9fa] min-h-screen">
            ...
            <section
                ...
                style={{
                    backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.35) 40%, rgba(0,0,0,0.15) 70%, rgba(0,0,0,0.05) 100%), url('/images/packages/package-3.jpg')`,
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        ...
                        <div className="flex flex-col gap-3 min-w-[280px]">
                            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-5">
                                ...
                                <div className="font-serif text-3xl font-semibold mb-3">$7,400 MXN</div>
                                <Link
            ...
            <div className="max-w-7xl mx-auto px-8 py-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                ...
                                <div className="font-semibold text-[#0a192f]">5 Días / 4 Noches</div>
                            </div>
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                ...
                                <div className="font-semibold text-[#0a192f] leading-tight">CHEPE Regional Primera Clase <span className="block text-[10px] text-gray-400 font-normal mt-1">(Aplicable a upgrade)</span></div>
                            </div>
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                    ...
                    <section>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="font-serif text-4xl text-[#0a192f] mb-2">$8,350 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#7B4B2A]">$465 <span className="text-sm">USD</span></div>
                                </div>
                                <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                    <div className="text-xs uppercase tracking-widest text-gray-400 font-semibold mb-6">Ocupación Triple</div>
                                    <div className="font-serif text-4xl text-[#0a192f] mb-2">$7,710 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#7B4B2A]">$430 <span className="text-sm">USD</span></div>
                                </div>
                                <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                    <div className="text-xs uppercase tracking-widest text-gray-400 font-semibold mb-6">Ocup. Cuádruple</div>
                                    <div className="font-serif text-4xl text-[#0a192f] mb-2">$7,400 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#7B4B2A]">$410 <span className="text-sm">USD</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pt-8 border-t border-gray-100">
                                <div>
                                    <h2 className="font-serif text-3xl text-[#0a192f] mb-2">Precio con Upgrade a CHEPE Express</h2>
                                    <p className="text-gray-500 text-sm">Comisionable al 10%. Mejora tu experiencia de viaje. Precios por persona.</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-[#0a192f] border border-[#1a2942] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="font-serif text-4xl text-white mb-2">$9,300 <span className="text-xl text-white/50 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#e5d3b3]">$515 <span className="text-sm text-white/50">USD</span></div>
                                </div>
                                <div className="bg-[#0a192f] border border-[#1a2942] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                    <div className="text-xs uppercase tracking-widest text-white/50 font-semibold mb-6">Ocupación Triple</div>
                                    <div className="font-serif text-4xl text-white mb-2">$8,700 <span className="text-xl text-white/50 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#e5d3b3]">$485 <span className="text-sm text-white/50">USD</span></div>
                                </div>
                                <div className="bg-[#0a192f] border border-[#1a2942] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                    <div className="text-xs uppercase tracking-widest text-white/50 font-semibold mb-6">Ocup. Cuádruple</div>
                                    <div className="font-serif text-4xl text-white mb-2">$8,400 <span className="text-xl text-white/50 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#e5d3b3]">$465 <span className="text-sm text-white/50">USD</span></div>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <div className="hidden lg:block lg:col-span-4 transition-all">
                    <div className="sticky top-32 bg-white rounded-3xl border border-gray-100 shadow-xl shadow-black/5 p-8">
                        <div className="mb-8">
                            ...
                            <h3 className="font-serif text-2xl text-[#0a192f]">Paquete 3</h3>
                        </div>
                        ...
                        <ul className="space-y-5 mb-10">
                            <li className="flex items-start gap-3 border-b border-gray-50 pb-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm font-medium text-[#0a192f]">5 Días / 4 Noches</div>
                                </div>
                            </li>
                            <li className="flex items-start gap-3 border-b border-gray-50 pb-4">
                        ...
                        <div className="bg-[#f8f9fa] rounded-2xl p-6 mb-6">
                            ...
                            <div className="font-serif text-3xl text-[#0a192f]">$7,400 <span className="text-base text-gray-500 font-sans">MXN</span></div>
                        </div>
