...
export const metadata: Metadata = {
    title: 'Paquete 14 - CHEPE Express Clase Turista | SIMATIRI',
    description: '5 Días / 4 Noches. Chihuahua – Creel – Los Mochis. Hospedaje Categoría Intermedia.',
}
    ...
    return (
        <div className="bg-[#f8f9fa] min-h-screen">
            <section
                ...
                style={{
                    backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.35) 40%, rgba(0,0,0,0.15) 70%, rgba(0,0,0,0.05) 100%), url('/images/packages/package-14.jpg')`,
                ...
                <div className="max-w-7xl mx-auto px-8 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div>
                            ...
                            <h1 className="font-serif text-5xl md:text-7xl mb-6 font-semibold tracking-tight">Paquete 14</h1>
            ...
            <div className="max-w-7xl mx-auto px-8 py-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
                <div className="lg:col-span-8 space-y-20">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[['Ocupación Doble', '$10,100'], ['Ocupación Triple', '$9,500'], ['Ocup. Cuádruple', '$9,240']].map(([label, price]) => (
                ...
                <div className="hidden lg:block lg:col-span-4">
                    <div className="sticky top-32 bg-white rounded-3xl border border-gray-100 shadow-xl shadow-black/5 p-8">
                        <div className="mb-8"><div className="text-xs uppercase tracking-widest text-[#7B4B2A] font-semibold mb-2">Resumen</div><h3 className="font-serif text-2xl text-[#0a192f]">Paquete 14</h3></div>
