...
export const metadata: Metadata = {
    title: 'Paquete 5 - CHEPE Regional Primera Clase | SIMATIRI',
    description: '4 Días / 3 Noches. Creel – Divisadero. Hospedaje Categoría Intermedia.',
}
    ...
    return (
        <div className="bg-[#f8f9fa] min-h-screen">
            ...
            <section
                ...
                style={{
                    backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.35) 40%, rgba(0,0,0,0.15) 70%, rgba(0,0,0,0.05) 100%), url('/images/packages/package-5.jpg')`,
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        ...
                        <div className="flex flex-col gap-3 min-w-[280px]">
                            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-5">
                                ...
                                <div className="font-serif text-3xl font-semibold mb-3">$7,200 MXN</div>
                                <Link
                        ...
                        <div className="mb-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="font-serif text-4xl text-[#0a192f] mb-2">$7,780 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#7B4B2A]">$435 <span className="text-sm">USD</span></div>
                                </div>
                                <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                ...
                                <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="font-serif text-4xl text-[#0a192f] mb-2">$7,200 <span className="text-xl text-gray-400 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#7B4B2A]">$400 <span className="text-sm">USD</span></div>
                                </div>
                            </div>
                        </div>

                        {/* Bloque 2: Upgrade CHEPE Express */}
                        <div>
                            <div className="mb-8 pt-8 border-t border-gray-100">
                                <h2 className="font-serif text-3xl text-[#0a192f] mb-2">Upgrade CHEPE Express Disponible</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-[#0a192f] border border-[#1a2942] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="font-serif text-4xl text-white mb-2">$8,850 <span className="text-xl text-white/50 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#e5d3b3]">$490 <span className="text-sm text-white/50">USD</span></div>
                                </div>
                                <div className="bg-[#0a192f] border border-[#1a2942] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    <div className="absolute top-0 left-0 w-full h-1 bg-[#7B4B2A] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                                ...
                                <div className="bg-[#0a192f] border border-[#1a2942] rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="font-serif text-4xl text-white mb-2">$8,150 <span className="text-xl text-white/50 font-sans">MXN</span></div>
                                    <div className="text-lg font-medium text-[#e5d3b3]">$450 <span className="text-sm text-white/50">USD</span></div>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <div className="hidden lg:block lg:col-span-4">
                    <div className="sticky top-32 bg-white rounded-3xl border border-gray-100 shadow-xl shadow-black/5 p-8">
                        <div className="mb-8">
                            ...
                            <h3 className="font-serif text-2xl text-[#0a192f]">Paquete 5</h3>
                        </div>
                        ...
                        <div className="bg-[#f8f9fa] rounded-2xl p-6 mb-6">
                            ...
                            <div className="font-serif text-3xl text-[#0a192f]">$7,200 <span className="text-base text-gray-500 font-sans">MXN</span></div>
                        </div>
