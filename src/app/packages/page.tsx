...
const STATIC_PACKAGE_PRICES: Record<number, StaticPrice[]> = {
    ...
    2: [
        { id: 201, occupancyType: 'DOBLE', pricePerPerson: 11400 },
        { id: 202, occupancyType: 'TRIPLE', pricePerPerson: 10470 },
        { id: 203, occupancyType: 'CUADRUPLE', pricePerPerson: 10100 },
        { id: 204, occupancyType: 'DOBLE', pricePerPerson: 12400, isUpgrade: true },
        { id: 205, occupancyType: 'TRIPLE', pricePerPerson: 11440, isUpgrade: true },
        { id: 206, occupancyType: 'CUADRUPLE', pricePerPerson: 11070, isUpgrade: true },
    ],
    3: [
        { id: 301, occupancyType: 'DOBLE', pricePerPerson: 9350 },
        { id: 302, occupancyType: 'TRIPLE', pricePerPerson: 8710 },
        { id: 303, occupancyType: 'CUADRUPLE', pricePerPerson: 8400 },
        { id: 304, occupancyType: 'DOBLE', pricePerPerson: 10300, isUpgrade: true },
        { id: 305, occupancyType: 'TRIPLE', pricePerPerson: 9700, isUpgrade: true },
        { id: 306, occupancyType: 'CUADRUPLE', pricePerPerson: 9400, isUpgrade: true },
    ],
    4: [
        { id: 401, occupancyType: 'DOBLE', pricePerPerson: 11400 },
        { id: 402, occupancyType: 'TRIPLE', pricePerPerson: 10200 },
        { id: 403, occupancyType: 'CUADRUPLE', pricePerPerson: 10100 },
    ],
    5: [
        { id: 501, occupancyType: 'DOBLE', pricePerPerson: 8380 },
        { id: 502, occupancyType: 'TRIPLE', pricePerPerson: 7900 },
        { id: 503, occupancyType: 'CUADRUPLE', pricePerPerson: 7700 },
        { id: 504, occupancyType: 'DOBLE', pricePerPerson: 9350, isUpgrade: true },
        { id: 505, occupancyType: 'TRIPLE', pricePerPerson: 8900, isUpgrade: true },
        { id: 506, occupancyType: 'CUADRUPLE', pricePerPerson: 8650, isUpgrade: true },
    ],
    6: [
        { id: 601, occupancyType: 'DOBLE', pricePerPerson: 10350 },
        { id: 602, occupancyType: 'TRIPLE', pricePerPerson: 9550 },
        { id: 603, occupancyType: 'CUADRUPLE', pricePerPerson: 9200 },
    ],
    7: [
        { id: 701, occupancyType: 'DOBLE', pricePerPerson: 7400 },
        { id: 702, occupancyType: 'TRIPLE', pricePerPerson: 7100 },
        { id: 703, occupancyType: 'CUADRUPLE', pricePerPerson: 6950 },
    ],
    8: [
        { id: 801, occupancyType: 'DOBLE', pricePerPerson: 9250 },
        { id: 802, occupancyType: 'TRIPLE', pricePerPerson: 8800 },
        { id: 803, occupancyType: 'CUADRUPLE', pricePerPerson: 8550 },
    ],
    9: [
        { id: 901, occupancyType: 'DOBLE', pricePerPerson: 8700 },
        { id: 902, occupancyType: 'TRIPLE', pricePerPerson: 8350 },
        { id: 903, occupancyType: 'CUADRUPLE', pricePerPerson: 8200 },
    ],
    10: [
        { id: 1001, occupancyType: 'DOBLE', pricePerPerson: 9200 },
        { id: 1002, occupancyType: 'TRIPLE', pricePerPerson: 8700 },
        { id: 1003, occupancyType: 'CUADRUPLE', pricePerPerson: 8500 },
    ],
    11: [
        { id: 1101, occupancyType: 'DOBLE', pricePerPerson: 10900 },
        { id: 1102, occupancyType: 'TRIPLE', pricePerPerson: 10100 },
        { id: 1103, occupancyType: 'CUADRUPLE', pricePerPerson: 9700 },
    ],
    12: [
        { id: 1201, occupancyType: 'DOBLE', pricePerPerson: 13200 },
        { id: 1202, occupancyType: 'TRIPLE', pricePerPerson: 12150 },
        { id: 1203, occupancyType: 'CUADRUPLE', pricePerPerson: 11600 },
    ],
    13: [
        { id: 1301, occupancyType: 'DOBLE', pricePerPerson: 18250 },
        { id: 1302, occupancyType: 'TRIPLE', pricePerPerson: 16580 },
        { id: 1303, occupancyType: 'CUADRUPLE', pricePerPerson: 15790 },
    ],
    14: [
        { id: 1401, occupancyType: 'DOBLE', pricePerPerson: 10100 },
        { id: 1402, occupancyType: 'TRIPLE', pricePerPerson: 9500 },
        { id: 1403, occupancyType: 'CUADRUPLE', pricePerPerson: 9240 },
    ],
    15: [
        { id: 1501, occupancyType: 'DOBLE', pricePerPerson: 12400 },
        { id: 1502, occupancyType: 'TRIPLE', pricePerPerson: 12150 },
        { id: 1503, occupancyType: 'CUADRUPLE', pricePerPerson: 11750 },
    ],
    16: [
        { id: 1601, occupancyType: 'DOBLE', pricePerPerson: 11650 },
        { id: 1602, occupancyType: 'TRIPLE', pricePerPerson: 10850 },
        { id: 1603, occupancyType: 'CUADRUPLE', pricePerPerson: 10450 },
    ],
    17: [
        { id: 1701, occupancyType: 'DOBLE', pricePerPerson: 9960 },
        { id: 1702, occupancyType: 'TRIPLE', pricePerPerson: 9500 },
        { id: 1703, occupancyType: 'CUADRUPLE', pricePerPerson: 9240 },
    ],
}
...
const STATIC_PACKAGES: Array<{ id: number; title: string; durationDays: number; trainClass: string; description: string; prices: StaticPrice[] }> = [
    ...
    { id: 9, title: 'Paquete 9', durationDays: 3, trainClass: 'CHEPE Express', description: STATIC_PACKAGE_ROUTES[9], prices: STATIC_PACKAGE_PRICES[9] ?? [] },
