    ...
    return (
        <>
            ...
            >
                ...
                <div className="p-6">
                    <h3 className="font-serif text-xl text-[#0a192f] mb-2 group-hover:text-[#2e4a3d] transition-colors">Tour Guachochi y Kokoyome</h3>
                    <p className="text-sm text-gray-500 mb-4">12 Horas de experiencia</p>
