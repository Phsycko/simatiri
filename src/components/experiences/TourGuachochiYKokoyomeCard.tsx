...
import { TourGuachochiYKokoyomeModal } from './TourGuachochiYKokoyomeModal'
import { ExperienceQuoteModal, buildExperienceQuoteData } from './ExperienceQuoteModal'
import Image from 'next/image'
import { useTranslation } from '@/contexts/LocaleContext'

export function TourGuachochiYKokoyomeCard({ tour }: { tour: any }) {
            ...
            >
                <div className="aspect-[4/3] bg-[#181410] overflow-hidden relative">
                    ...
                    <div className="absolute bottom-4 left-4 flex items-center gap-2 text-white/90 text-xs font-medium">
                        <Clock size={13} />
                        {tour?.durationHours || 12} {t('common.horas')}
                    </div>
                </div>
                <div className="p-6">
                    ...
                    <h2 className="font-serif text-xl text-[#0a192f] mb-3 group-hover:text-[#2e4a3d] transition-colors">Tour Guachochi y Kokoyome</h2>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 mb-5">
                        ...
                        <div className="space-y-1.5">
                            {(tour?.tierPrices?.length > 1
                                ...
                                : [
                                    { minPax: 1, maxPax: 2, pricePerPerson: 2000 },
                                    { minPax: 3, maxPax: 6, pricePerPerson: 1600 },
                                    { minPax: 7, maxPax: 11, pricePerPerson: 1400 },
                                ].map((fb, i) => (
