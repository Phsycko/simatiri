...
interface TourGuachochiYKokoyomeModalProps {
    isOpen: boolean
...
export function TourGuachochiYKokoyomeModal({ isOpen, setIsOpen, tour, onRequestQuote }: TourGuachochiYKokoyomeModalProps) {
                        ...
                        >
                            ...
                            <div className="overflow-y-auto w-full max-h-full no-scrollbar">
                                ...
                                <div className="relative h-64 md:h-80 w-full bg-[#111]">
                                    <Image src="/images/experiences/tour-guachochi-kokoyome-v2.jpg" alt="Tour Guachochi y Kokoyome" fill sizes="(max-width: 768px) 100vw, 800px" className="w-full h-full object-cover " />
                                ...
                                <div className="p-8 md:p-12 pt-0 flex flex-col md:flex-row gap-10 md:gap-16">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-5 text-sm text-gray-500 font-medium mb-8 pb-8 border-b border-gray-100 flex-wrap">
                                            <div className="flex items-center gap-2">
                                                <Clock size={16} className="text-[#7B4B2A]" /> 12 horas aproximadamente
                                            </div>
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <ul className="space-y-4">
                                                {[
                                                    ...
                                                    "Kokoyome",
                                                    "Mirador a la Barranca de la Sinforosa",
                                                    "Lago de Las Garzas",
                                                    "Cascada El Salto"
                                                ].map((lugar, i) => (
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
                                                {tour?.tierPrices?.length ? (
                                                    ...
                                                    [
                                                        { min: 1, max: 2, price: 2400 },
                                                        { min: 3, max: 6, price: 2000 },
                                                        { min: 7, max: 11, price: 1800 },
                                    ...
                                    <div className="w-full md:w-72 lg:w-80 flex flex-col">
                                        <div className="bg-[#f8f9fa] rounded-3xl p-6 md:p-8 border border-gray-100 mb-6 relative overflow-hidden">
                                            ...
                                            <ul className="space-y-4 mb-8">
                                                {[
                                                    "El Tour Guachochi y Kokoyome no incluye entradas a los lugares de interés",
