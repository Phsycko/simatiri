...
interface TourMenonitasModalProps {
    isOpen: boolean
    setIsOpen: (open: boolean) => void
    tour: any
}

export function TourMenonitasModal({ isOpen, setIsOpen, tour }: TourMenonitasModalProps) {
                        ...
                        >
                            ...
                            <div className="overflow-y-auto w-full max-h-full no-scrollbar">
                                ...
                                <div className="relative h-64 md:h-80 w-full bg-[#111]">
                                    <Image src="/images/destinations/cuauhtemoc.jpg" alt="Tour Menonitas" fill sizes="(max-width: 768px) 100vw, 800px" className="w-full h-full object-cover opacity-90" />
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 pb-6 md:pb-8">
                                        <div className="flex items-center gap-3 text-[#7B4B2A] text-xs font-semibold uppercase tracking-widest mb-3">
                                            <MapPin size={14} /> Cuauhtémoc / Chihuahua
                                        </div>
                                ...
                                <div className="p-8 md:p-12 pt-0 flex flex-col md:flex-row gap-10 md:gap-16">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-5 text-sm text-gray-500 font-medium mb-8 pb-8 border-b border-gray-100 flex-wrap">
                                            <div className="flex items-center gap-2">
                                                <Clock size={16} className="text-[#7B4B2A]" /> 5 – 6 horas aproximadamente
                                            </div>
                                            <div className="hidden sm:block w-px h-4 bg-gray-200" />
                                            <div className="flex items-center gap-2">
                                                <Compass size={16} className="text-[#7B4B2A]" /> Cultura y Tradición
                                            </div>
                                        </div>
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <ul className="space-y-4">
                                                {[
                                                    ...
                                                    "Quesería Menonita",
                                                    "Colonia Menonita",
                                                    "Pizzería Menonita (no incluye consumo)"
                                                ].map((lugar, i) => (
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
                                                {[
                                                    { min: 1, max: 2, price: 1300 },
                                                    { min: 3, max: 6, price: 1100 },
                                                    { min: 7, max: 11, price: 950 },
                                                    { min: 12, max: 14, price: 850 },
                                                    { min: 15, max: 38, price: 750 },
                                                    { min: 39, max: "en adelante", price: 650 },
                                                ].map((t, i) => (
                                    ...
                                    <div className="w-full md:w-72 lg:w-80 flex flex-col">
                                        <div className="bg-[#f8f9fa] rounded-3xl p-6 md:p-8 border border-gray-100 mb-6 relative overflow-hidden">
                                            ...
                                            <ul className="space-y-4 mb-8">
                                                {[
                                                    "El Tour Menonitas no incluye entradas a los lugares de interés",
                                                    "Al igual que los consumos dentro de los lugares a visitar",
                                                    "Por lo que se recomienda llevar efectivo"
                                                ].map((item, i) => (
                                                    <li key={i} className="flex items-start gap-3 text-sm text-gray-600">
