...
interface TourMaguarichiModalProps {
    isOpen: boolean
...
export function TourMaguarichiModal({ isOpen, setIsOpen, tour, onRequestQuote }: TourMaguarichiModalProps) {
                        ...
                        >
                            ...
                            <div className="overflow-y-auto w-full max-h-full no-scrollbar">
                                ...
                                <div className="relative h-64 md:h-80 w-full bg-[#111]">
                                    <Image src="/images/experiences/tour-maguarichi-geisers-v2.jpg" alt="Tour Maguarichi y los Géisers de Chihuahua" fill sizes="(max-width: 768px) 100vw, 800px" className="w-full h-full object-cover " />
                                    <div className="absolute inset-0 bg-gradient-to-t from-white via-white/10 to-transparent" />
                                    <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 pb-6 md:pb-8">
                                        <h2 className="font-serif text-4xl md:text-5xl lg:text-5xl text-[#0a192f] leading-none mb-2">
                                            Tour Maguarichi y los Géisers de Chihuahua
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div className="p-8 md:p-12 pt-0 flex flex-col md:flex-row gap-10 md:gap-16">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <ul className="space-y-4">
                                                {[
                                                    "Visita a los géisers",
                                                    "Aromaterapia con meditación guiada",
                                                    "Fangoterapia",
                                                    "Experiencia gastronómica de snacks preparados al vapor",
                                                    "Aguas termales “Los Manzanos”"
                                                ].map((lugar, i) => (
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
                                                {tour?.tierPrices?.length ? (
                                                    ...
                                                    [
                                                        ...
                                                        { min: 15, max: 38, price: 1350 },
                                                        { min: 39, max: "en adelante", price: 1250 },
                                                    ].map((fb, i) => (
                                    ...
                                    <div className="w-full md:w-72 lg:w-80 flex flex-col">
                                        <div className="bg-[#f8f9fa] rounded-3xl p-6 md:p-8 border border-gray-100 mb-6 relative overflow-hidden">
                                            ...
                                            <ul className="space-y-4 mb-8">
                                                {[
                                                    "El Tour Maguarichi no incluye entradas a los lugares de interés",
