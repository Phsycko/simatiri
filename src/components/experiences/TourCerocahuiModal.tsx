...
interface TourCerocahuiModalProps {
    isOpen: boolean
...
export function TourCerocahuiModal({ isOpen, setIsOpen, tour, onRequestQuote }: TourCerocahuiModalProps) {
    const { t } = useTranslation()
    const [imgSrc, setImgSrc] = useState('/images/destinations/cerocahui.jpg')
                        ...
                        >
                            ...
                            <div className="overflow-y-auto w-full max-h-full no-scrollbar">
                                ...
                                <div className="relative h-64 md:h-80 w-full bg-[#111]">
                                    <Image src="/images/experiences/tour-cerocahui-mirador-del-gallego-v2.jpg" alt="Tour Cerocahui y Mirador del Gallego" fill sizes="(max-width: 768px) 100vw, 800px" className="w-full h-full object-cover " />
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 pb-6 md:pb-8">
                                        <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-[#0a192f] leading-none mb-2">
                                            Tour Cerocahui y Mirador del Gallego
                                        </h2>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-5 text-sm text-gray-500 font-medium mb-8 pb-8 border-b border-gray-100 flex-wrap">
                                            <div className="flex items-center gap-2">
                                                <Clock size={16} className="text-[#7B4B2A]" /> 10 horas aproximadamente
                                            </div>
                                            <div className="hidden sm:block w-px h-4 bg-gray-200" />
                                            <div className="flex items-center gap-2">
                                                <Compass size={16} className="text-[#7B4B2A]" /> Aventura y Cultura
                                            </div>
                                        </div>
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <p className="text-gray-600 leading-relaxed">
                                                Salida desde el lugar acordado; se puede recoger al grupo en el hotel en el que se hospedan. Llegada al punto de origen al finalizar.
                                            </p>
                                        </div>
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <ul className="space-y-4">
                                                {[
                                                    "Mirador del Gallego",
                                                    "Manantial de Guadalupe",
                                                    "Misión Jesuita de Cerocahui",
                                                    "Internado de niños Rarámuris",
                                                    "Viñedo de Cerocahui"
                                                ].map((lugar, i) => (
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
                                                {tour?.tierPrices?.length ? (
                                                    ...
                                                    [
                                                        ...
                                                        { min: 7, max: 11, price: 1500 },
                                                        { min: 12, max: 14, price: 1400 },
                                                        { min: 15, max: 38, price: 1300 },
                                                        { min: 39, max: "en adelante", price: 1150 },
                                                    ].map((fb, i) => (
                                                        <div key={i} className={`flex items-center justify-between p-4 ${i !== 5 ? 'border-b border-gray-100' : ''}`}>
                                                            <span className="text-gray-600 font-medium">{fb.min} – {fb.max} {t('common.pax')}</span>
                                                            <span className="text-[#0a192f] font-semibold text-lg">${fb.price.toLocaleString('en-US', { minimumFractionDigits: 2 })} <span className="text-sm text-gray-400 font-normal">{t('common.mxn')}</span></span>
                                                        </div>
                                                    ))
                                                )}
                                            </div>
                                        ...
                                        <div className="bg-[#f8f9fa] rounded-3xl p-6 md:p-8 border border-gray-100 mb-6 relative overflow-hidden">
                                            ...
                                            <ul className="space-y-4 mb-8">
                                                {[
                                                    ...
                                                    "Chofer y guía",
                                                    "Cata de vinos opcional con costo extra"
                                                ].map((item, i) => (
                                            ...
                                            <ul className="space-y-4 mb-8">
                                                {[
                                                    "El Tour Cerocahui no incluye entradas a los lugares de interés",
                                                    "Tampoco incluye los consumos dentro de los lugares a visitar",
