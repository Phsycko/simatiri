...
interface TourRecowataModalProps {
    isOpen: boolean
...
export function TourRecowataModal({ isOpen, setIsOpen, tour, onRequestQuote }: TourRecowataModalProps) {
    const { t } = useTranslation()
    // Bloquear scroll del body cuando el modal está abierto del body cuando el modal está abierto
    useEffect(() => {
        if (isOpen) {
                                ...
                                <div className="p-8 md:p-12 pt-0 flex flex-col md:flex-row gap-10 md:gap-16">
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
                                                {tour?.tierPrices?.length ? (
                                                    ...
                                                    [
                                                        ...
                                                        { min: 3, max: 6, price: 1100 },
                                                        { min: 7, max: 11, price: 1000 },
                                                        { min: 12, max: 14, price: 950 },
                                    ...
                                    <div className="w-full md:w-72 lg:w-80 flex flex-col">
                                        <div className="bg-[#f8f9fa] rounded-3xl p-6 md:p-8 border border-gray-100 mb-6 relative overflow-hidden">
                                            ...
                                            <ul className="space-y-4 mb-8">
                                                {[
                                                    "El Tour Recowata no incluye entradas a los lugares de interés",
                                                    "Tampoco incluye los consumos dentro de los lugares a visitar",
                                                    "Se recomienda llevar efectivo",
                                                    "En el tour únicamente se lleva al grupo a la caseta de entrada a las aguas termales, y se recoge al grupo en ese mismo lugar",
                                                    "Los viajeros tienen que bajar y subir el cañón caminando, o pueden contratar los servicios de los ejidatarios Tarahumaras"
                                                ].map((item, i) => (
                                                    <li key={i} className="flex items-start gap-3 text-sm text-gray-600">
