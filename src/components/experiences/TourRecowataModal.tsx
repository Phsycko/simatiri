...
export function TourRecowataModal({ isOpen, setIsOpen, tour }: TourRecowataModalProps) {
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
                                                {[
                                                    ...
                                                    { min: 12, max: 14, price: 350 },
                                                    { min: 15, max: 38, price: 300 },
                                                    { min: 39, max: "en adelante", price: 250 },
                                                ].map((t, i) => (
