...
interface HikingBarrancasModalProps {
    isOpen: boolean
...
export function HikingBarrancasModal({ isOpen, setIsOpen, tour, onRequestQuote }: HikingBarrancasModalProps) {
    ...
    const displayPrice = tour.tierPrices?.[0]?.pricePerPerson ?? 5000
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-5 text-sm text-gray-500 font-medium mb-8 pb-8 border-b border-gray-100">
                                            <div className="flex items-center gap-2">
                                                <Mountain size={16} className="text-[#7B4B2A]" /> {t('generic.naturalezaSenderismo')}
                                            </div>
                                        </div>
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <p className="text-gray-600 leading-relaxed">
                                                Vive la sierra a pie: senderos entre cañones, miradores de vértigo y silencio solo roto por el viento. Una experiencia inmersiva de naturaleza y esfuerzo que recompensa con algunas de las vistas más imponentes de México. Diseñada para quienes buscan conectar con el paisaje de las Barrancas del Cobre más allá del mirador.
                                            </p>
                                        </div>
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 p-4">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-[#0a192f] font-semibold text-lg">Desde ${displayPrice.toLocaleString('es-MX')} <span className="text-sm text-gray-400 font-normal">{t('common.mxn')}</span></span>
                                                </div>
                                                <p className="text-xs text-gray-400 mt-2">{t('generic.precioSegunGrupo')}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full md:w-72 lg:w-80 flex flex-col">
                                        <div className="bg-[#f8f9fa] rounded-3xl p-6 md:p-8 border border-gray-100 mb-6 relative overflow-hidden">
                                            ...
                                            <ul className="space-y-4 mb-8">
                                                {[
                                                    'Guía especializado en senderismo',
                                                    'Ruta según condición del grupo',
                                                    'Vistas a cañones y miradores',
                                                    'Experiencia en pequeño grupo',
