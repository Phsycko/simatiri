                        ...
                        >
                            ...
                            <div className="overflow-y-auto w-full max-h-full no-scrollbar">
                                ...
                                <div className="relative h-64 md:h-80 w-full bg-[#111]">
                                    <Image src="/images/experiences/tour-basaseachi-v2.jpg" alt="Tour Basaseachi" fill sizes="(max-width: 768px) 100vw, 800px" className="w-full h-full object-cover " />
