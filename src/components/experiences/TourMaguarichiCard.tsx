...
import { TourMaguarichiModal } from './TourMaguarichiModal'
import { ExperienceQuoteModal, buildExperienceQuoteData } from './ExperienceQuoteModal'
import Image from 'next/image'
import { useTranslation } from '@/contexts/LocaleContext'

export function TourMaguarichiCard({ tour }: { tour: any }) {
        ...
        <>
            ...
            >
                ...
                <div className="p-6">
                    ...
                    <h2 className="font-serif text-xl text-[#0a192f] mb-3 group-hover:text-[#2e4a3d] transition-colors">Tour Maguarichi y los Géisers de Chihuahua</h2>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 mb-5">
                        ...
                        <div className="space-y-1.5">
                            {(tour?.tierPrices?.length > 1
                                ...
                                : [
                                    { minPax: 1, maxPax: 2, pricePerPerson: 1900 },
                                    { minPax: 3, maxPax: 6, pricePerPerson: 1700 },
