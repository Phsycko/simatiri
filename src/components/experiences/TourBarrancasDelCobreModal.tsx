...
export function TourBarrancasDelCobreModal({ isOpen, setIsOpen, tour }: TourBarrancasDelCobreModalProps) {
                        ...
                        >
                            ...
                            <div className="overflow-y-auto w-full max-h-full no-scrollbar">
                                ...
                                <div className="relative h-64 md:h-80 w-full bg-[#111]">
                                    <Image src="/images/destinations/barrancas-del-cobre.jpg" alt="Tour Barrancas del Cobre" fill sizes="(max-width: 768px) 100vw, 800px" className="w-full h-full object-cover opacity-90" />
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-5 text-sm text-gray-500 font-medium mb-8 pb-8 border-b border-gray-100 flex-wrap">
                                            <div className="flex items-center gap-2">
                                                <Clock size={16} className="text-[#7B4B2A]" /> {tour?.durationHours || 5} horas aproximadamente
                                            </div>
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100">
                                                {tour?.tierPrices ? (
                                                    ...
                                                    <>
                                                        {/* Fallback en caso de que no haya base de datos cargada */}
                                                        {[
                                                            { min: 1, max: 2, price: 800 },
                                                            { min: 3, max: 6, price: 695 },
                                                            { min: 7, max: 11, price: 595 },
                                                            { min: 12, max: 14, price: 495 },
                                                            { min: 15, max: 38, price: 445 },
                                                            { min: 39, max: "en adelante", price: 395 },
                                                        ].map((t, i) => (
